    ...
    <div className=" header__container-1">
      ...
      <div className="headerExplainer-asnblack">
         ...
         Referral Program Invitation
           ...
           <p style={{maxWidth:"70%",color:"white",fontSize:"1rem",lineHeight:"1",fontWeight:"500",textAlign:"center",display:"flex",alignItems:"center",color:"white",position:"relative",top:"-1rem"}}>
           Hello [User Name],
            <br/>
       ...
       When they sign up and start trading, you’ll earn [specific reward, e.g., cash bonuses, trading credits].
           ...
           <p style={{maxWidth:"70%",color:"white",fontSize:"1.2rem",lineHeight:"1",fontWeight:"500",textAlign:"center",display:"flex",alignItems:"center",color:"#2f9ffas",position:"relative",top:"-1rem"}}>
           ...
           <p style={{maxWidth:"70%",color:"white",fontSize:"1rem",lineHeight:"1",fontWeight:"500",textAlign:"center",display:"flex",alignItems:"center",color:"white",marginTop:"-0.5rem"}}>

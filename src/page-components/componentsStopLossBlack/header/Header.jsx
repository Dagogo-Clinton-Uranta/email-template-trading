    ...
    <div className=" header__container-1">
      ...
      <div className="headerExplainer-kycblack">
         ...
         Stop-Loss/Take-Profit
           ...
           <p style={{maxWidth:"70%",color:"white",fontSize:"1rem",lineHeight:"1",fontWeight:"400",textAlign:"center",display:"flex",alignItems:"center",color:"white",position:"relative",top:"0rem"}}>
           Hello [User Name],
            <br/>
      ...
      This is a notification that your [Stop-Loss/Take-Profit] order has been triggered.
       ...
       {/*
           <p style={{maxWidth:"70%",color:"white",fontSize:"1.2rem",lineHeight:"1",fontWeight:"600",textAlign:"center"}}>

    ...
    <div className=" header__container-1">
      ...
      <div className="headerExplainer-asnblack">
         ...
         Platform Maintenance Notification
           ...
           <p style={{maxWidth:"70%",color:"white",fontSize:"1rem",lineHeight:"1",fontWeight:"500",textAlign:"center",display:"flex",alignItems:"center",color:"white",position:"relative",top:"2rem"}}>
           Hello [User Name],
            <br/>

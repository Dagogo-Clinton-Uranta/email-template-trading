    ...
    <div className=" header__container-1">
      ...
      <div className="headerExplainer-wel">
         ...
         Account Verification
           ...
           <p style={{maxWidth:"70%",color:"black",fontSize:"1rem",lineHeight:"1",fontWeight:"700",textAlign:"center",display:"flex",alignItems:"center",color:"black"}}>
           Here’s a quick overview of what you can do on our platform:
           </p>


           <p style={{maxWidth:"70%",color:"black",fontSize:"1rem",lineHeight:"1",fontWeight:"300",textAlign:"center",display:"flex",alignItems:"center",color:"black"}}>
           Hello [User Name],
           <br/>
         To complete your registration with Tradx.io, we need to verify your account. Please take a moment to verify your email address or identity.
           ...
           <p style={{maxWidth:"70%",color:"black",fontSize:"1.2rem",lineHeight:"1",fontWeight:"700",textAlign:"center",display:"flex",alignItems:"center",color:"#2f9ffa"}}>
          Verification Link
           </p>


           <p style={{maxWidth:"70%",color:"black",fontSize:"1.2rem",lineHeight:"1",fontWeight:"700",textAlign:"center",display:"flex",alignItems:"center",color:"black",color:" #9AA0A9"}}>
            What's Next:
           </p>



           <p style={{maxWidth:"70%",color:"black",fontSize:"1.1rem",lineHeight:"1",fontWeight:"400",textAlign:"left",marginTop:"0rem",marginBottom:"0rem"}}>
           Once your account is verified, you’ll have full access to all our features.

           </p>

       
           <p style={{maxWidth:"70%",color:"black",fontSize:"1.1rem",lineHeight:"1",fontWeight:"400",textAlign:"left"}}>
           ...
           <p style={{maxWidth:"70%",color:"black",fontSize:"1.2rem",lineHeight:"1",fontWeight:"700",textAlign:"center",display:"flex",alignItems:"center",color:"black",marginTop:"1rem"}}>
